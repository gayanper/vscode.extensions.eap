...
mvn -f ./jdt-repo-releng/repository/pom.xml org.eclipse.tycho:tycho-p2-repository-plugin:4.0.4:verify-repository && \
    /usr/bin/python3 $script_dir/patch-p2-repository.py && \
    mvn -f ./jdt-repo-releng/repository/pom.xml org.eclipse.tycho:tycho-p2-repository-plugin:4.0.4:fix-artifacts-metadata && \
    mvn -f ./jdt-repo-releng/repository/pom.xml org.eclipse.tycho:tycho-p2-repository-plugin:4.0.4:verify-repository
