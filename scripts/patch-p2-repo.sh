...
ln -s $PWD/jdt-repo-releng/target/repository-jdtincu $PWD/jdt-repo-releng/target/repository && \
    mvn -f ./jdt-repo-releng/pom.xml org.eclipse.tycho:tycho-p2-repository-plugin:4.0.4:verify-repository && rm $PWD/jdt-repo-releng/target/repository && \
    ...
    ln -s $PWD/jdt-repo-releng/target/repository-jdtincu $PWD/jdt-repo-releng/target/repository && \
    mvn -f ./jdt-repo-releng/pom.xml org.eclipse.tycho:tycho-p2-repository-plugin:4.0.4:fix-artifacts-metadata && rm $PWD/jdt-repo-releng/target/repository && \
